...
function Projects({ isDark }) {
  const projects = [
    {
      title: "wedding photo studio management system",
      desc: "express js and react js based wedding photo studio management system to manage appointments, client records, and photo galleries.",
